...
import ExerciseLibraryCards from "../../Components/HomePage/ExerciseLibrary/ExerciseLibraryCards";
  ...
  return (
    <div className="mx-4 md:mx-6 lg:mx-9  my-10 md:my-14 lg:my-16">
      ...
      <div className="text-center ">
        <h2 className="font-oswald font-bold text-2xl md:text-3xl text-white ">
          All Workouts
        </h2>
        <p className="font-inter text-sm lg:text-base text-[#9CA3AF] mt-3">
